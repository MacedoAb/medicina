...
<div style="font-size: 15px;">
	Atesto para fins trabalhistas que o Sr(a) <b><?php echo $nome_paciente ?></b> portador do CPF nº
	 <?php echo $cpf_paciente ?> esteve sob cuidados profissionais no dia __/__/____ e deverá se afastar 
	 de suas atividades pelo período de <b><?php echo $datas ?></b> por motivo de <?php echo $motivo ?>
</div>
